$(document).ready(function() {
	...
	// Resource Names
	////////////////
	$resource_1_name = "ツムコイン";
	$resource_2_name = "ツムゴールド";
	
	////////////////
	// Console Messages
	////////////////
	$console_message_1 = "読み込み中...";
	$console_message_2 = "作成";
	$console_message_3 = "正常に生成されました";
	$console_message_4 = "完全な世代...";
	$console_message_5 = "自動検証の実行...";
	$console_message_6 = "自動検証に失敗しました";
	$console_message_7 = "手動で確認してください";
	...
	// Resource 2
	$resource_2_value_1 = "1000";
	$resource_2_value_2 = "2000";
	$resource_2_value_3 = "4000";
	$resource_2_value_4 = "6000";
